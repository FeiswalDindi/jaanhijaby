@pushOnce('scripts')
    ...
    >
        <div class="mt-2 max-md:mt-3">
            ...
            <input type="hidden" :name="controlName + '.country'" value="KE">
            <input type="hidden" :name="controlName + '.postcode'" value="00100">
            <input type="hidden" :name="controlName + '.city'" value="Kenya">
